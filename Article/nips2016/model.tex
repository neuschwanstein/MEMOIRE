...
$\Fhat$ observed in the sample can suffer from severe overfitting \comment{References
  needed!} and produce investment policies that perform badly out of sample. This is for
