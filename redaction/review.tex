...
trop brusquement en ne laissant pas suffisamment de place aux garanties
...
alors garantir un regret dont la progression du est de $\bigO(\sqrt{T})$. Un tel
algorithme induisant un regret sous linéaire, \ie\ dominé par $\bigO(T)$, est appelé
