...
% L'étude scientifique de l'optimisation de portefeuille a d'abod été théorisée à partir des
% années 1950 par Harry Markowitz. Si le modèle utilisé par Morkowitz est à bien des égards
% trop simples pour une application robuste, il a le mérite d'être,  
